...
from models import InlineResponse200, RegressionApiBody
...
app = MCPProxy(
    ...
    version='1.0',
    servers=[{'url': 'https://services.scideas.net'}],
)


@app.post('/regression/api', tags=['regression_analysis'])
def post_regression_api(body: RegressionApiBody):
    """
